...
def PrincipalMain(response):
    ...
    Res = Answer(Resultados, repositorio[3],repositorio[4], True)
    MandoEmail(response[1], repositorio[3], repositorio[4])
...
def Answer(Resultados, User, RepositorioD, MeterHistorial):
    score = ""
    file_directory = "/home/ivanlb1/TFG2/"
    print "*****************"
...
def MandoEmail(destino, User, Repo):
    print destino
    destino = destino.split("%40")
    fromaddr = 'bestforkivan@gmail.com'
    toaddrs  = destino[0]+"@"+destino[1]
    print toaddrs
    msg = 'Correo enviado desde BestFork. \n Visite:+'+":8000/hist.html___"+User+"___"+Repo
